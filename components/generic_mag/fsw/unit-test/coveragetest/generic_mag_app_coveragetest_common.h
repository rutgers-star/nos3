 ...
 * @file
 *
 * Common definitions for all generic_mag_app coverage tests
 */

#ifndef GENERIC_mag_APP_COVERAGETEST_COMMON_H
#define GENERIC_mag_APP_COVERAGETEST_COMMON_H
...
#endif /* GENERIC_mag_APP_COVERAGETEST_COMMON_H */
