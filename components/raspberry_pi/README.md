# Raspberry_pi - NOS3 Component
This repository contains the NOS3 Raspberry_pi Component.
This includes flight software (FSW), ground software (GSW), simulation, and support directories.

## Component Template
This component template utilizes canned files from the existing [raspberry_pi component](https://github.com/nasa-itc/raspberry_pi) to generate a new component to do development in.
...
## Overview
In addition to being used by the template generator, the raspberry_pi component provides an executable example for the user.
This raspberry_pi component is a UART device that accepts multiple commands, including requests for telemetry and data.
The available FSW is for use in the core Flight System (cFS) while the GSW supports COSMOS.
A NOS3 simulation is available which includes both raspberry_pi and 42 data providers.
...
* Raspberry_pi
  ...
  - uint32, Command Counter
    * Increments for each command received
  - uint16, Data X
    * X component of raspberry_pi data
  - uint16, Data Y
    * X component of raspberry_pi data
  - uint16, Data Z
    * X component of raspberry_pi data
...
## FSW
Refer to the file [fsw/platform_inc/raspberry_pi_platform_cfg.h](fsw/platform_inc/raspberry_pi_platform_cfg.h) for the default
    ...
    <hardware-model>
        ...
        <connections>
            <connection><type>command</type>
                ...
                <node-name>raspberry_pi-sim-command-node</node-name>
            </connection>
...
```
        <data-provider>
            <type>RASPBERRY_PI_42_PROVIDER</type>
...
* make debug
* cd ./components/raspberry_pi/support
* mkdir build
* cd build
* cmake .. 
...
* make
* make checkout
  * Launches NOS Engine, NOS Time Driver, NOS Terminal, Raspberry_pi Sim, and Raspberry_pi Checkout
* make stop

# Documentation
If this raspberry_pi application had an ICD and/or test procedure, they would be linked here.
