 ...
 *
 * Purpose:
 * Extra scaffolding functions for the raspberry_pi_app unit test
 *
 * Notes:
...
#ifndef UT_RASPBERRY_PI_APP_H
#define UT_RASPBERRY_PI_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "RASPBERRY_PI_APP_Data_t" typedef.
 */
#include "raspberry_pi_app.h"

/*
 * Allow UT access to the global "RASPBERRY_PI_APP_Data" object.
 */
// extern RASPBERRY_PI_AppData_t RASPBERRY_PI_APP_Data;

#endif /* UT_RASPBERRY_PI_APP_H */
