module Components {
    ...
    active component Raspberry_piSim {
        ...
        @ Command to initialize Sequence Raspberry_pi HK
        async command RASPBERRY_PI_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Raspberry_pi
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Raspberry_pi
