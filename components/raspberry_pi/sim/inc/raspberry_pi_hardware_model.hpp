#ifndef NOS3_RASPBERRY_PIHARDWAREMODEL_HPP
#define NOS3_RASPBERRY_PIHARDWAREMODEL_HPP
...
** Defines
*/
#define RASPBERRY_PI_SIM_SUCCESS 0
#define RASPBERRY_PI_SIM_ERROR   1
...
namespace Nos3
{
    ...
    class Raspberry_piHardwareModel : public SimIHardwareModel
    {
    public:
        /* Constructor and destructor */
        Raspberry_piHardwareModel(const boost::property_tree::ptree& config);
        ~Raspberry_piHardwareModel(void);

    private:
        /* Private helper methods */
        void create_raspberry_pi_hk(std::vector<uint8_t>& out_data); 
        void create_raspberry_pi_data(std::vector<uint8_t>& out_data); 
        ...
        SimIDataProvider*                                   _raspberry_pi_dp; /* Only needed if the sim has a data provider */
