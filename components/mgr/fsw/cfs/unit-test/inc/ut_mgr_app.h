 ...
 *
 * Purpose:
 * Extra scaffolding functions for the mgr_app unit test
 *
 * Notes:
 ...
 * "MGR_APP_Data_t" typedef.
 */
#include "mgr_app.h"

/*
 * Allow UT access to the global "MGR_APP_Data" object.
 */
// extern MGR_AppData_t MGR_APP_Data;
