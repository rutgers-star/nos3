 ...
 *
 * Purpose:
 * Extra scaffolding functions for the tmp100_app unit test
 *
 * Notes:
...
#ifndef UT_TMP100_APP_H
#define UT_TMP100_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "TMP100_APP_Data_t" typedef.
 */
#include "tmp100_app.h"

/*
 * Allow UT access to the global "TMP100_APP_Data" object.
 */
// extern TMP100_AppData_t TMP100_APP_Data;

#endif /* UT_TMP100_APP_H */
