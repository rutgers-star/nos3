 ...
 * @file
 *
 * Common definitions for all tmp100_app coverage tests
 */

#ifndef TMP100_APP_COVERAGETEST_COMMON_H
#define TMP100_APP_COVERAGETEST_COMMON_H
 ...
 */
#define ADD_TEST(test) UtTest_Add((Test_##test), Tmp100_UT_Setup, Tmp100_UT_TearDown, #test)
...
#endif /* TMP100_APP_COVERAGETEST_COMMON_H */
