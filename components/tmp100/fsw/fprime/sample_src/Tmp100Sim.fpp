module Components {
    ...
    active component Tmp100Sim {
        ...
        @ Command to initialize Sequence Tmp100 HK
        async command TMP100_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Tmp100
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Tmp100
